...
public class TetrisMain extends Canvas implements Runnable, KeyListener{
	...
	highScore.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
		    ...
		    // have set screen not resizeable,
	...
	while (running) {
	    ...
	    render(g); // is something here causing this to run very slow?
	    buf.show();
	}
    }
    // continue means jump to next iteration of loop (in this case the
    // while loop)
