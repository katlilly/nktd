...
We have begun with a tetris game as a way to get started, to familiarize ourselves with speech recognition software, and to learn
...
After this we intend to add at least one additional game. We are exploring the possibility of games that may be more interesting to
control by voice than tetris is, where the gameplay is improved or changed by
being voice controlled. For example, there is a Mario-like game called Scream Go
\url{} where the character is controlled by the pitch and volume of
the player's voice, rather than with voice commands. Another example
is Full Voice Throttle \url{}, a car racing game where acceleration is
controlled by ... pitch? turning?
...
We spoke to the manager of the disability support unit here at Otago, and talked
with her about what the real needs of students and staff here are. Her
main point was that mental health issues are the biggest issue, and so we briefly explored the possibility of a project aimed at supporting Otago students in this area. However, none of us were particularly keen to take on such a weighty issue as this, and we also felt that a project like this would involve a lot of work writing content and doing research about non CS topics, which is not how we would prefer to spend most of our effort.
...
\ganttbar{\small Research voice recognition}{19}{29} \\
\ganttbar{\small Tetris game logic}{19}{29} \\
\ganttbar{\small Create basic app}{19}{47} \\


\ganttbar{\small Tetris-specific voice commands}{33}{47} \\
\ganttbar[progress=20]{\small Tetris graphics in java}{33}{58} \\
\ganttbar[progress=50]{\small Researching other games}{33}{58} \\
\ganttmilestone{1st Report due}{47} \\

% Stage 2 - to Alpha Release
\ganttbar[bar/.append style={fill=gray}]{\small Tetris running in Android app}{47}{72} \\
\ganttbar[bar/.append style={fill=gray}]{\small Tetris controllable by voice}{47}{89} \\
\ganttbar[bar/.append style={fill=gray}]{\small App works on tablet and phone}{75}{89} \\
\ganttbar[bar/.append style={fill=gray}]{\small Start writing second game}{75}{117} \\
