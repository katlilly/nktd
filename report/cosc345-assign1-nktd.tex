...
changed by being voice controlled. For example, there is a Mario-like
game called Scream Go
\url{https://www.youtube.com/watch?v=IyvjpgS9TAs} where a character
navigates a world by walking and jumping movements, which are
...
% of course not limited to those unable to use hands, hopefully our
% game is fun enough to be worth playing for anyone
...
\end{ganttchart}
\caption{Rough outline of the whole-project timeline. We have divided
  the time into 15 two-week sprints, beginning Monday 5th March and
  ending Monday 1st October}
\label{fig:ganttyear}
\end{figure}
%\end{landscape}
