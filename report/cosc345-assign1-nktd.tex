...
We have begun with a tetris game as a way to get started and
familiarise ourselves with the speech recognition software and learn
...
After this we intend to add at least one additional game. We intend to
explore the possibility of games that may be more interesting to
control by voice than tetris is, where the gameplay is improved by
being voice controlled rather than keyboard or touchscreen
controlled. For example, there is a Mario-like game called Scream Go
...
is Full Voice Throttle \url{}, a car racing game where accelaration is
...
talk about why games

what we want to get out of this project - a fun challenge, none of us
had written games before. doable goals within the one year timescale,
eg, using existing games to get started with.
