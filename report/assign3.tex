...
\begin{itemize}
	...
	\item In Teragram, have implemented a button that when pressed will open up	the 
	two times table. 
\end{itemize}
...
subtraction problems or multiplication where you can practice your
times tables.
...
\href{https://github.com/kthakore/frozen-bubble}
